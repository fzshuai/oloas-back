...
import com.fzshuai.system.service.IWfDefinitionService;
...
public class WfDefinitionServiceImpl extends FlowServiceFactory implements IWfDefinitionService {
    ...
    private LambdaQueryWrapper<WfDefinitionVo> buildQueryWrapper(WfDefinitionVo bo) {
        LambdaQueryWrapper<WfDefinitionVo> lqw = Wrappers.lambdaQuery();
        lqw.like(StringUtils.isNotBlank(bo.getFormName()), WfDefinitionVo::getFormName, bo.getFormName());
        return lqw;
    }
}
